...
import yaml
import pickle
from load_data import load_vocs, init_data, load_session_data,load_session_data_one_hot_labels,load_session_data_domain
...
def main():
    ...
    session_data_dict = load_session_data_domain(config['data_params']['path_train'], config['model_params']['feature_names'], vocs, max_len)
    ...
    model.fit(
        data_dict=session_data_dict, dev_size=config['model_params']['dev_size'])
