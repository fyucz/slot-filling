...
from load_data import load_vocs, init_data, load_session_data, load_session_infer_data
...
def main():
    ...
    session_data_dict = load_session_data(config['data_params']['path_test'], feature_names, vocs, max_len,model='test')
...
if __name__ == '__main__':
    ...
    test_f1_with_sklearn(SLOT_DIC_DIEOS)
